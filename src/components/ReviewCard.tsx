...
const ReviewCard = ({ img, name, date, comment, rating }: Props) => {
    const imageUrl = "https://images.unsplash.com/photo-1732919258508-3fd53a8007b6?q=80&w=1976&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                ...
                <div className='flex justify-between'>
                    ...
                    <div className='flex'>
                        {[1, 2, 3, 4, 5].map((_, index) => (
                            <>
                                {
                                    rating >= index + 1 ? (<TiStarFullOutline className='text-orange-400' />) : (<TiStarOutline className='text-slate-400' />)
                                }
                            </>
