  ...
  return (
    <div
      className={`${size === "lg" ? "w-64 p-4" : "w-40 p-2"
        } ${activeCard ? "border-orange-400" : "border-transparent"} border bg-white shadow-md rounded-lg overflow-hidden text-center`}
    >
      {/* Product Image */}
      <div
        className={`${size === "lg" ? "p-6" : "p-4"
          } flex justify-center h-24 items-center`}
      >
        <img
          src={productImage}
          alt={productName}
          className={`${size === "lg" ? "w-full" : "w-24"
