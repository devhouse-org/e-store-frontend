            ...
            <Slider {...settings}>
                {products.map((product) => (
                    <div key={product.id} className="px-2">
                        <div className="border rounded-lg p-4 flex flex-col items-center gap-2 h-full bg-white">
                            <img
                                src={`data:image/png;base64,${product.image_1920}`}
                                alt={product.name}
                                className="w-32 h-32 object-contain rounded-lg"
                            />
                            <h3 className="text-sm font-semibold text-center font-tajawal-regular line-clamp-2">
                                {product.name}
                            </h3>
                            ...
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-tajawal-regular w-full justify-center ${isCompared(product.id.toString())
