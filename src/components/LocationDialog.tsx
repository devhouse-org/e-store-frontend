...
const LocationDialog = ({ location, phoneNumber2, phoneNumber, city, province, country }: Props) => {
    return (
        <Dialog>
            ...
            <DialogContent className="sm:max-w-md">
                <div className="py-8" dir="rtl">
                    <div className="flex gap-x-4 border-b">
                        <p className="font-tajawal-bold text-xl mt-4 max-w-[250px] truncate">عنوان الشحن</p>
                    </div>
                    ...
                    <div className='mt-4'>
                        <CustomInput label='رقم الهاتف الاحتياطي' placeholder={phoneNumber2} />
                    </div>
                    <div className='mt-4'>
