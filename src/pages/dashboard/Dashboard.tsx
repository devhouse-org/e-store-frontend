                        ...
                        <div className="mb-4 flex gap-x-4 items-center">
                            ...
                            <div className="w-full">
                                <div className='flex-1 flex justify-between items-center'>
                                    <strong>name</strong>
                                    <PenLine className='text-orange-500 p-1 rounded-md hover:bg-slate-200/50 transition ease-in-out cursor-pointer' size={24} />
                                </div>
                                <div className='flex-1'><p className='text-[12px]'>email@example.com</p></div>
                            </div>
                        </div>
                        <ul>
                            {
                            ...
                            <li>
                                <button className="mt-4 text-sm w-full py-1 rounded-md">تسجيل خروج</button>
                            </li>
                        </ul>
                    </div>
                </div>
